# @mcp-z/mcp-pdf tool reference

Detailed parameters and examples for the tools summarized in the [package README](https://github.com/mcp-z/mcp-pdf/blob/master/README.md).
